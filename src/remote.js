...
;(function(window, document) {
  ...
  linkEl.href = 'https://1literzinalco.github.io/src/themes/cyborg.min.css';
  linkEl.rel = 'stylesheet';
  document.head.appendChild(linkEl);

  var linkEl = document.createElement('link');
  linkEl.href = 'https://1literzinalco.github.io/src/strapdown.css';
  linkEl.rel = 'stylesheet';
  document.head.appendChild(linkEl);

  var linkEl = document.createElement('link');
  linkEl.href = 'https://1literzinalco.github.io/src/themes/bootstrap-responsive.min.css';
  linkEl.rel = 'stylesheet';
  document.head.appendChild(linkEl);
